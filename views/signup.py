...
class SignUpView(tk.Frame):
    def __init__(self, *args, **kwargs):
        ...
        self.header = tk.Label(self, text="Create a new account")
        self.header.grid(row=0, column=0, columnspan=2, padx=10, pady=10)

        self.fullname_label = tk.Label(self, text="Full Name")
        self.fullname_input = tk.Entry(self)
        ...
        self.has_agreed = tk.BooleanVar()
        self.agreement = tk.Checkbutton(
            self,
        ...
        self.signin_option_label = tk.Label(self, text="Already have an "
                                                     "account?")
